                            ...
                            <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                                ...
                                <tbody>
                                    ...
                                    <td align="left" style="font-family: sans-serif; font-size: 14px; vertical-align: top; padding-bottom: 15px;">
                                        ...
                                        <tbody>
                                            <tr>
                                            <td style="font-family: 'Pattaya', sans-serif; font-size: 14px; vertical-align: top; background-color: #3498db; border-radius: 5px; text-align: center;"> <a href='${config.server}/activate/${token}/${req.body.username}' target="_blank" style="display: inline-block; color: #ffffff; background-color: #3498db; border: solid 1px #3498db; border-radius: 5px; box-sizing: border-box; cursor: pointer; text-decoration: none; font-size: 14px; font-weight: bold; margin: 0; padding: 12px 25px; text-transform: capitalize; border-color: #3498db;">Confirm account</a> </td>
                                            </tr>
                                        </tbody>
                                        </table>
                                    </td>
