...
function (_Component) {
  ...
  _createClass(SignupPage, [{
    ...
    value: function render() {
      ...
      }), this.state.inputs.password.length == 0 && this.state.errors.password ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("label", {
        style: {
          color: 'red'
        },
        __source: {
...
//# sourceMappingURL=0.1b37e71fd62e5e90f143.hot-update.js.map